...
public class EmpleadoControllerTests {
    ...
    void testListarEmpleados() throws Exception {
        ...
        listaEmpleados.add(Empleado.builder().nombre("Julen").apellido("Ramirez").email("j1@gmail.com").build());
        listaEmpleados.add(Empleado.builder().nombre("Biaggio").apellido("Ramirez").email("b1@gmail.com").build());
        listaEmpleados.add(Empleado.builder().nombre("Adrian").apellido("Ramirez").email("a1@gmail.com").build());
